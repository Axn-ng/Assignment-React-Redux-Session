...
// ── LAB STEP 2: Polling & refetchOnFocus ──────────────────────────────────────
// pollingInterval: 30_000  → refetch ทุก 30 วินาทีอัตโนมัติ
// refetchOnFocus: true     → refetch เมื่อแท็บเบราว์เซอร์กลับมา focus
// refetchOnReconnect: true → refetch หลังเครือข่ายเชื่อมต่อใหม่
// refetchOnMountOrArgChange: true → refetch ทุกครั้งที่ mount component
